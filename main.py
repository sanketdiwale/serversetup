...
os.system('addhost '+args.URL)

# setup nginx config
os.system('sudo python nginx_setup.py '+args.User+' '+args.Sitename+' '+args.URL)
...
# setup ssl
os.system('sudo python ssl_selfsigned_setup.py '+args.Sitename+' '+args.URL)

# reload and restart the services
# start the gunicorn service as a daemon
os.system('sudo daemon-reload')
